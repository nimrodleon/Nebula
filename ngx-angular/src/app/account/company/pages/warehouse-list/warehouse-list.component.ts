...
export class WarehouseListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe(params => {
      ...
      this.getWarehouses(this.companyId);
    });
  ...
  private getWarehouses(companyId: string): void {
    this.warehouseService.index(this.query.value, companyId)
  ...
  public saveChangesDetail(response: WarehouseDataModal): void {
    ...
    if (response.type === "ADD") {
      this.warehouseService.create(warehouse, this.companyId)
        .subscribe(result => {
    ...
    if (response.type === "EDIT") {
      this.warehouseService.update(warehouse.id, warehouse, this.companyId)
        .subscribe(result => {
  ...
  public deleteWarehouse(id: string): void {
    deleteConfirm().then(result => {
      if (result.isConfirmed) {
        this.warehouseService.delete(id, this.companyId).subscribe(result => {
