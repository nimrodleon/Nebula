...
import { ForgotPasswordRequest, ResetPasswordRequest, User, UserRegister, UserRegisterFromAdmin } from "../interfaces";
...
export class UserService {
  ...
  public registerFromAdmin(user: UserRegisterFromAdmin): Observable<any> {
    return this.http.post(`${this.baseUrl}/RegisterFromAdmin`, user)
      .pipe(catchError(err => {
        toastError(err.error);
        throw err;
      }));
  ...
  public updateFromAdmin(id: string, user: UserRegisterFromAdmin): Observable<any> {
