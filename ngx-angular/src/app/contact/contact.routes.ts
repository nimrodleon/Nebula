...
import {ContactDetailMaterialesComponent} from "./pages/contact-detail-materiales/contact-detail-materiales.component";
...
export const routes: Routes = [
  ...
  {path: "detail/:id/materiales", component: ContactDetailMaterialesComponent},
  {path: "**", redirectTo: ""}
];
