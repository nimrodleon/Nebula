...
import { confirmTask, initializeSelect2Injector, PaginationResult, TipoComprobanteDataModal } from "app/common/interfaces";
...
export class SalesListComponent implements OnInit {
  ...
  public nuevoComprobante(): void {
    this.router.navigate(["/", this.companyId, "sales", "form"], {
      queryParams: {
        origin: 0,
        cid: "NaN"
      }
