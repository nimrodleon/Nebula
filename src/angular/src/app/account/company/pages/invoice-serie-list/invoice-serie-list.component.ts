...
export class InvoiceSerieListComponent {
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe(params => {
      ...
      this.getInvoiceSeries(this.companyId);
    });
  ...
  private getInvoiceSeries(companyId: string): void {
    this.invoiceSerieService.index(this.query.value, companyId)
  ...
  public editInvoiceSerieModal(id: string): void {
    ...
    this.invoiceSerieService.show(id, this.companyId)
      .subscribe(result => {
  ...
  public saveChangesDetail(data: InvoiceSerieDataModal): void {
    if (data.type === "ADD") {
      this.invoiceSerieService.create(data.invoiceSerie, this.companyId)
        .subscribe(result => {
    ...
    if (data.type === "EDIT") {
      this.invoiceSerieService.update(data.invoiceSerie.id, data.invoiceSerie, this.companyId)
        .subscribe(result => {
  ...
  public deleteInvoiceSerie(id: string): void {
    deleteConfirm().then(result => {
      if (result.isConfirmed) {
        this.invoiceSerieService.delete(id, this.companyId)
          .subscribe(result => {
