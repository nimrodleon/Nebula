...
public class CashierSaleService
{
    ...
    public async Task<InvoiceSale> SaveChanges(string id)
    {
        ...
        var invoiceSaleDetails = _generarVenta.GetInvoiceSaleDetails(invoiceSale.Id, cajaDiaria.Id, invoiceSerie.WarehouseId);
    ...
    public async Task<InvoiceSaleDto> GetInvoiceSaleDto(string invoiceSaleId)
    {
